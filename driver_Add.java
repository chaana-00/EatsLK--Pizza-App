            ...
            public void onClick(View view) {
                ...
                if(n1.equals("")||n2.equals("")||n3.equals("")||n4.equals("")||n5.equals("")||n6.equals("")||n7.equals("")||n8.equals("")){
                    ...
                    try {
                        ...
                        DatabaseReference tasksRef = rootRef.child("Drivers").push();
                        tasksRef.child("Email").setValue(newdriveremail.getText().toString().trim());
                        tasksRef.child("Name").setValue(newdrivername.getText().toString().trim());
                        tasksRef.child("Contact").setValue(newdrivernumber.getText().toString().trim());
