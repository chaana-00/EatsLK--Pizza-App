    ...
    private void insertTODB() {
       ...
       sqlhelper obj = new sqlhelper(this, "FoodDB.sqlite",null, 1);
        ...
        if( obj.insertData(deliveryModel.getfName(),deliveryModel.getlName(),
            ...
            DatabaseReference tasksRef1 = rootRef1.child("Orders").push();
            tasksRef1.child("Name").setValue(deliveryModel.getfName());
            tasksRef1.child("Contact_No").setValue(deliveryModel.getContact());
            tasksRef1.child("Product_Id").setValue(name.getText().toString());
            tasksRef1.child("QTY").setValue(name2.getText().toString());
